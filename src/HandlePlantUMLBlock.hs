...
-- |
-- | The Attr type (Attr = (String, [String], [(String, String)])) contains the
-- | following information:
-- | First String: Block identifier (for use as a reference target such as a
-- | LaTeX identifier).
-- | [String]: A list of classes for the CodeBlock. We are mainly interested
-- | in the "plantuml" class, which indicates that we should transform the
-- | content of the CodeBlock.
-- | [(String, String)]: A list of (Key, Value) pairs used to modify the
...
isProcessAttr (k, _) = k `elem` ["caption", "format"]
